...
var _defaults: Dictionary[String, Dictionary] = {
	...
	"devices.data_logging.start": { "order": 4.92, "label": "Start Logging", "type": "bool", "default": true },
	...
	"devices.data_logging.instrumented_wheels.path": { "order": 4.97, "label": "NextWheel path", "type": "file", "default": "D:/Maria_school/Documents/S2026/nextwheel/software/python/nextwheel" },
