...
var _defaults: Dictionary[String, Dictionary] = {
	...
	"overlays.biofeedback_push_pattern.enabled": { "order": 3.03, "label": "Biofeedback Push pattern", "type": "bool", "default": false },
	"overlays.contact_angle_start": { "order": 3.04, "label": "Contact angle start", "unit": "deg", "type": "float", "default": -55.0, "min": -65.0, "max": 20.0 },
	"overlays.contact_angle_end": { "order": 3.05, "label": "Contact angle end", "unit": "deg", "type": "float", "default": 55.0, "min": 20.0, "max": 140.0 },
