...
func _ready() -> void:
	list = [
		{
			"coordinates": coordinates_lateral_epicondyl,
			"node": node_lateral_epicondyl,
			"node_frame": node_arm_cluster
		},
		{
			"coordinates": coordinates_medial_epicondyl,
			"node": node_medial_epicondyl,
			"node_frame": node_arm_cluster
		},
		{
			"coordinates": coordinates_acromion,
			"node": node_acromion,
			"node_frame": node_arm_cluster
		},
		{
			"coordinates": coordinates_radial_styloid,
			"node": node_radial_styloid,
			"node_frame": node_forearm_cluster
		},
		{
			"coordinates": coordinates_ulnar_styloid,
			"node": node_ulnar_styloid,
			"node_frame": node_forearm_cluster
		},
	]
...
func _process(delta: float) -> void:
	...
	arm_coordinate_system["y"] = (
		node_acromion.position
		- 0.5 * (node_lateral_epicondyl.position + node_medial_epicondyl.position)
	)
	...
	arm_coordinate_system["x"] = (
		arm_coordinate_system["y"].cross(arm_coordinate_system["z"]).normalized()
	)
	arm_coordinate_system["y"] = (
		arm_coordinate_system["z"].cross(arm_coordinate_system["x"]).normalized()
	)
	...
	forearm_coordinate_system["y"] = (
		0.5 * (node_lateral_epicondyl.position + node_medial_epicondyl.position)
		- node_ulnar_styloid.position
	)
	...
	forearm_coordinate_system["x"] = (
		forearm_coordinate_system["y"].cross(forearm_coordinate_system["z"]).normalized()
	)
	forearm_coordinate_system["y"] = (
		forearm_coordinate_system["z"].cross(forearm_coordinate_system["x"]).normalized()
	)
	...
	var forearm_in_arm = (
		arm_coordinate_system["transform"].affine_inverse() * forearm_coordinate_system["transform"]
	)
